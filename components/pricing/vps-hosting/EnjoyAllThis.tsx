...
import { Lock, Globe, RefreshCw, Server, Shield } from 'lucide-react';
import { useTranslations } from 'next-intl';

export default function EnjoyAllThis() {
  const t = useTranslations('vpsHosting.enjoyAllThis');

  const features = [
    { icon: Shield, key: 'ssl' },
    { icon: Server, key: 'domain' },
    { icon: RefreshCw, key: 'backups' },
    { icon: Lock, key: 'email' },
    { icon: Globe, key: 'traffic' },
  ];
