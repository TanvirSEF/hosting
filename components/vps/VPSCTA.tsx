...
const WEBSITE_IMAGES = [
  { src: '/images/vps-hosting/cta-ecommerce.png', alt: 'E-commerce Website' },
  { src: '/images/vps-hosting/cta-saas.png', alt: 'SaaS Website' },
  { src: '/images/vps-hosting/cta-restaurant.png', alt: 'Restaurant Website' },
  { src: '/images/vps-hosting/cta-portfolio.png', alt: 'Portfolio Website' },
  { src: '/images/vps-hosting/cta-blog.png', alt: 'Blog Website' },
  { src: '/images/vps-hosting/cta-fitness.png', alt: 'Fitness Website' },
  { src: '/images/vps-hosting/cta-realestate.png', alt: 'Real Estate Website' },
  { src: '/images/vps-hosting/cta-agency.png', alt: 'Agency Website' },
  {
    src: '/images/vps-hosting/cta-photography.png',
    alt: 'Photography Website',
  },
  { src: '/images/vps-hosting/cta-law.png', alt: 'Law Firm Website' },
  { src: '/images/vps-hosting/cta-medical.png', alt: 'Medical Clinic Website' },
  { src: '/images/vps-hosting/cta-education.png', alt: 'Education Website' },
  { src: '/images/vps-hosting/cta-travel.png', alt: 'Travel Website' },
  { src: '/images/vps-hosting/cta-music.png', alt: 'Music Website' },
  { src: '/images/vps-hosting/cta-nonprofit.png', alt: 'Nonprofit Website' },
  { src: '/images/vps-hosting/cta-beauty.png', alt: 'Beauty Spa Website' },
  {
    src: '/images/vps-hosting/cta-architecture.png',
    alt: 'Architecture Website',
  },
  { src: '/images/vps-hosting/cta-gaming.png', alt: 'Gaming Website' },
  { src: '/images/vps-hosting/cta-pet.png', alt: 'Pet Store Website' },
  { src: '/images/vps-hosting/cta-bakery.png', alt: 'Bakery Website' },
];
