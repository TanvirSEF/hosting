...
export default function Stats() {
  const t = useTranslations('shared-hosting.stats');
...
function StatItem({
  ...
  return (
    <div className="flex flex-col items-center justify-center p-1">
      <div className="font-dm-sans mb-1 text-3xl leading-tight font-bold text-[#FFFFFF] sm:text-4xl md:text-4xl lg:text-5xl xl:text-6xl 2xl:text-7xl transform-gpu will-change-[contents,transform]">
        {count}
        {suffix}
      </div>
