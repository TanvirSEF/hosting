...
export default function SharedWhyChoose() {
    const t = useTranslations('shared-hosting.whyChoose');
                    ...
                    <div className="flex flex-col w-full lg:flex-1 gap-3">
                        {tabs.map((tab) => (
                            <div
                                ...
                                className={cn(
                                    "relative flex flex-col p-6 cursor-pointer transition-all duration-300 rounded-[16px] border-l-4",
                                    activeTab === tab.id
