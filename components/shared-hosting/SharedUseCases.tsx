...
function UseCaseCard({
  ...
  const y = useTransform(progress, [start, end], [0, -800]);
  const opacity = useTransform(progress, [start, start + 0.1], [1, 0]);
...
export default function SharedUseCases() {
  const t = useTranslations('shared-hosting.useCases');
  ...
  return (
    ...
    >
      <div className="sticky top-0 flex h-screen flex-col justify-start overflow-hidden pt-20 pb-10 lg:justify-center lg:pt-0 lg:pb-0">
