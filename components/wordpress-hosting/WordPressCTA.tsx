...
const WEBSITE_IMAGES = [
  {
    src: '/images/wordpress-hosting/cta-ecommerce.png',
    alt: 'E-commerce Website',
  },
  { src: '/images/wordpress-hosting/cta-saas.png', alt: 'SaaS Website' },
  {
    src: '/images/wordpress-hosting/cta-restaurant.png',
    alt: 'Restaurant Website',
  },
  {
    src: '/images/wordpress-hosting/cta-portfolio.png',
    alt: 'Portfolio Website',
  },
  { src: '/images/wordpress-hosting/cta-blog.png', alt: 'Blog Website' },
  { src: '/images/wordpress-hosting/cta-fitness.png', alt: 'Fitness Website' },
  {
    src: '/images/wordpress-hosting/cta-realestate.png',
    alt: 'Real Estate Website',
  },
  { src: '/images/wordpress-hosting/cta-agency.png', alt: 'Agency Website' },
  {
    src: '/images/wordpress-hosting/cta-photography.png',
    alt: 'Photography Website',
  },
  { src: '/images/wordpress-hosting/cta-law.png', alt: 'Law Firm Website' },
  {
    src: '/images/wordpress-hosting/cta-medical.png',
    alt: 'Medical Clinic Website',
  },
  {
    src: '/images/wordpress-hosting/cta-education.png',
    alt: 'Education Website',
  },
  { src: '/images/wordpress-hosting/cta-travel.png', alt: 'Travel Website' },
  { src: '/images/wordpress-hosting/cta-music.png', alt: 'Music Website' },
  {
    src: '/images/wordpress-hosting/cta-nonprofit.png',
    alt: 'Nonprofit Website',
  },
  {
    src: '/images/wordpress-hosting/cta-beauty.png',
    alt: 'Beauty Spa Website',
  },
  {
    src: '/images/wordpress-hosting/cta-architecture.png',
    alt: 'Architecture Website',
  },
  { src: '/images/wordpress-hosting/cta-gaming.png', alt: 'Gaming Website' },
  { src: '/images/wordpress-hosting/cta-pet.png', alt: 'Pet Store Website' },
  { src: '/images/wordpress-hosting/cta-bakery.png', alt: 'Bakery Website' },
];
