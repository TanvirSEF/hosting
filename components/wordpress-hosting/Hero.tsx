...
export default function Hero() {
  const t = useTranslations('wordpress-hosting.hero');
      ...
      <div className="relative z-10 container mx-auto flex h-full w-full max-w-[1920px] flex-col items-center justify-center gap-8 px-4 pt-28 pb-12 sm:px-6 md:gap-8 md:px-6 md:py-6 lg:flex-row lg:justify-between lg:gap-10 lg:px-12 lg:py-8 xl:gap-16 xl:px-20 xl:py-10 2xl:gap-24 2xl:px-32">
        ...
        <div className="flex w-full max-w-xl flex-1 flex-col items-center text-center lg:max-w-lg lg:items-start lg:text-left xl:max-w-2xl 2xl:max-w-4xl">
          ...
          <div className="mb-6 flex w-full flex-col items-center md:mb-4 lg:mb-5 lg:items-start">
            ...
            <div className="grid grid-cols-2 justify-items-center gap-2 text-sm font-light text-[#F9F6FF] opacity-80 sm:gap-3 sm:text-sm md:gap-4 md:text-sm lg:justify-items-start lg:gap-5 lg:text-sm xl:gap-6 xl:text-base 2xl:text-lg">
        ...
        <div className="relative hidden w-full flex-1 items-center justify-end lg:flex">
          <div className="relative h-[365px] w-[420px] xl:h-[535px] xl:w-[600px] 2xl:h-[609px] 2xl:w-[700px]">
            <Image
              src="https://pub-36186a09bf9045098760abadf24720aa.r2.dev/public/images/wordpress-hosting/wordpresshero.webp"
              alt="WordPress Hosting Infrastructure"
              fill
