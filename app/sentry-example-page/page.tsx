...
export default function Page() {
  ...
  useEffect(() => {
    ...
    Sentry.metrics.count("test_client_metric", 1);
    Sentry.metrics.distribution("test_page_load_time", 120);
      ...
      <main>
        ...
        <p className="description">
          ...
          <a
            target="_blank"
            rel="noopener"
            href="https://webbly-media-digital-solutions.sentry.io/issues/?project=4511320801804368"
          >
            Issues Page
          </a>
